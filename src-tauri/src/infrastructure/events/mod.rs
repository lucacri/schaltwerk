...
pub enum SchaltEvent {
    ...
    GitLabStatusChanged,
    ForgeStatusChanged,
    ForgePrDetailsRefreshed,
    ForgeConnectionIssue,
    DevBackendError,
...
impl SchaltEvent {
    pub fn as_str(&self) -> &'static str {
        match self {
            ...
            SchaltEvent::ForgeStatusChanged => "schaltwerk:forge-status-changed",
            SchaltEvent::ForgePrDetailsRefreshed => "schaltwerk:forge-pr-details-refreshed",
            SchaltEvent::ForgeConnectionIssue => "schaltwerk:forge-connection-issue",

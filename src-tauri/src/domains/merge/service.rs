...
impl MergeService {
    ...
    pub fn preview_with_worktree(&self, session_name: &str) -> Result<MergePreview> {
        ...
        let commits = collect_commits_ahead(&repo, session_commit.id(), parent_commit.id(), COMMIT_SUMMARY_LIMIT)?;
    ...
    pub fn preview(&self, session_name: &str) -> Result<MergePreview> {
        ...
        let commits = collect_commits_ahead(&repo, context.session_oid, context.parent_oid, COMMIT_SUMMARY_LIMIT)?;
...
const COMMIT_SUMMARY_LIMIT: usize = 50;

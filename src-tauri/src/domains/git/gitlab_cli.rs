...
impl<R: CommandRunner> GitlabCli<R> {
    ...
    pub fn get_pipeline_jobs(
        ...
        gitlab_project: &str,
        hostname: Option<&str>,
    ) -> Result<Vec<GitlabPipelineJob>, GitlabCliError> {
        debug!(
            "[GitlabCli] Fetching pipeline jobs: project={}, branch={}",
            project_path.display(),
            branch
        );
    ...
    fn create_session_mr_reapply_mode() {
        ...
        let result = cli
            .create_session_mr(CreateSessionMrOptions {
                ...
                session_branch: "lucode/test-session",
                base_branch: "main",
                mr_branch_name: "lucode/test-session",
                title: "Test MR",
                description: None,
                gitlab_project: "group/project",
                hostname: None,
        ...
        assert_eq!(result.source_branch, "lucode/test-session");
    }

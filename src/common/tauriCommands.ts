...
export const TauriCommands = {
  ...
  ForgeGetStatus: 'forge_get_status',
  ForgeSearchIssues: 'forge_search_issues',
  ForgeGetIssueDetails: 'forge_get_issue_details',
  ForgeSearchPrs: 'forge_search_prs',
  ForgeGetPrDetails: 'forge_get_pr_details',
  ForgeCreateSessionPr: 'forge_create_session_pr',
  ForgeGetReviewComments: 'forge_get_review_comments',
  ForgeApprovePr: 'forge_approve_pr',
  ForgeMergePr: 'forge_merge_pr',
  ForgeCommentOnPr: 'forge_comment_on_pr',
  ForgeCommentOnIssue: 'forge_comment_on_issue',
  ForgeGenerateWriteback: 'forge_generate_writeback',
  ForgeProxyImage: 'forge_proxy_image',
  SessionSetAutofix: 'session_set_autofix',
  SessionGetAutofix: 'session_get_autofix',
  SessionTryAutofix: 'session_try_autofix',
  ...
  GetEnabledAgents: 'get_enabled_agents',
  GetAgentEnvVars: 'get_agent_env_vars',
  GetAgentPreferences: 'get_agent_preferences',
  GetContextualActions: 'get_contextual_actions',
  GetAgentPresets: 'get_agent_presets',
  GetAgentVariants: 'get_agent_variants',
  GetFavoriteOrder: 'get_favorite_order',
  GetRawAgentOrder: 'get_raw_agent_order',
  ...
  GetEnabledOpenAppIds: 'get_enabled_open_app_ids',
  GetEditorOverrides: 'get_editor_overrides',
  ...
  ListOpenAppCatalog: 'list_open_app_catalog',
  ...
  // Task aggregate (Phase 7 Wave A.1.b)
  // Reads
  LucodeTaskList: 'lucode_task_list',
  LucodeTaskGet: 'lucode_task_get',
  LucodeTaskRunList: 'lucode_task_run_list',
  LucodeTaskRunGet: 'lucode_task_run_get',
  LucodeTaskArtifactHistory: 'lucode_task_artifact_history',
  LucodeTaskListStageConfigs: 'lucode_task_list_stage_configs',
  LucodeProjectWorkflowDefaultsGet: 'lucode_project_workflow_defaults_get',
  // Lifecycle writes
  LucodeTaskCreate: 'lucode_task_create',
  LucodeTaskUpdateContent: 'lucode_task_update_content',
  LucodeTaskAdvanceStage: 'lucode_task_advance_stage',
  LucodeTaskAttachIssue: 'lucode_task_attach_issue',
  LucodeTaskAttachPr: 'lucode_task_attach_pr',
  ...
  LucodeTaskStartStageRun: 'lucode_task_start_stage_run',
  LucodeTaskStartClarifyRun: 'lucode_task_start_clarify_run',
  LucodeTaskRunCancel: 'lucode_task_run_cancel',
  LucodeTaskConfirmStage: 'lucode_task_confirm_stage',
  LucodeTaskRunDone: 'lucode_task_run_done',
  // Project workflow defaults
  LucodeProjectWorkflowDefaultsSet: 'lucode_project_workflow_defaults_set',
  LucodeProjectWorkflowDefaultsDelete: 'lucode_project_workflow_defaults_delete',
  ...
  RefreshTerminalView: 'refresh_terminal_view',
  ...
  SchaltwerkCoreGetConsolidationStats: 'schaltwerk_core_get_consolidation_stats',
  SchaltwerkCoreUpdateConsolidationOutcomeVertical: 'schaltwerk_core_update_consolidation_outcome_vertical',
  ...
  SchaltwerkCoreLinkSessionToIssue: 'schaltwerk_core_link_session_to_issue',
  SchaltwerkCoreLinkSessionToPr: 'schaltwerk_core_link_session_to_pr',
  SchaltwerkCoreUnlinkSessionFromIssue: 'schaltwerk_core_unlink_session_from_issue',
  ...
  SchaltwerkCoreSetSpecStage: 'schaltwerk_core_set_spec_stage',
  SchaltwerkCoreSetSpecAttentionRequired: 'schaltwerk_core_set_spec_attention_required',
  ...
  SchaltwerkCoreSetSpecClarificationAgentType: 'schaltwerk_core_set_spec_clarification_agent_type',
  ...
  SchaltwerkCoreStartSpecOrchestrator: 'schaltwerk_core_start_spec_orchestrator',
  SchaltwerkCoreSubmitSpecClarificationPrompt: 'schaltwerk_core_submit_spec_clarification_prompt',
  ...
  SchaltwerkCoreListSpecReviewComments: 'schaltwerk_core_list_spec_review_comments',
  SchaltwerkCoreSaveSpecReviewComments: 'schaltwerk_core_save_spec_review_comments',
  SchaltwerkCoreClearSpecReviewComments: 'schaltwerk_core_clear_spec_review_comments',
  ...
  SchaltwerkCoreResetSpecOrchestrator: 'schaltwerk_core_reset_spec_orchestrator',
  ...
  SetContextualActions: 'set_contextual_actions',
  ResetContextualActionsToDefaults: 'reset_contextual_actions_to_defaults',
  SetAgentPresets: 'set_agent_presets',
  SetAgentVariants: 'set_agent_variants',
  SetFavoriteOrder: 'set_favorite_order',
  SetRawAgentOrder: 'set_raw_agent_order',
  SetDefaultOpenApp: 'set_default_open_app',
  SetEnabledOpenAppIds: 'set_enabled_open_app_ids',
  SetEditorOverrides: 'set_editor_overrides',

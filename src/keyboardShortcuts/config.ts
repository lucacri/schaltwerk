...
export const defaultShortcutConfig: KeyboardShortcutConfig = {
  ...
  [KeyboardShortcutAction.SelectPrevSession]: createNormalizedBindings(['Mod+ArrowUp', 'Alt+Shift+`']),
  [KeyboardShortcutAction.SelectNextSession]: createNormalizedBindings(['Mod+ArrowDown', 'Alt+`']),

...
export const KEYBOARD_SHORTCUT_SECTIONS: ShortcutSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        action: KeyboardShortcutAction.SelectPrevSession,
        label: 'Previous sidebar item',
        description: 'Cycles the orchestrator, specs, agents, and version-group members.',
      },
      {
        action: KeyboardShortcutAction.SelectNextSession,

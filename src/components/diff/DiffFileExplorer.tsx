      ...
      >
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 justify-between">
            <div className="truncate" style={{ fontSize: theme.fontSize.body, color: 'var(--color-text-primary)' }}>
              {node.name}
            </div>
            <div className="flex items-center gap-1.5 flex-shrink-0">
              ...
              {commentCount > 0 && (
                <div
                  ...
                  style={{ fontSize: theme.fontSize.caption, color: 'var(--color-accent-blue-light)' }}
                >
                  <VscComment size={12} />
  ...
  return (
    ...
    >
      <div className="p-3 border-b border-slate-800">
        <div className="font-medium mb-1" style={{ fontSize: theme.fontSize.body }}>Changed Files</div>
        <div className="text-slate-500" style={{ fontSize: theme.fontSize.caption }}>{files.length} files</div>
      </div>
        ...
        <div className="p-3 border-t border-slate-800 flex flex-col gap-3">
          ...
          <div className="space-y-2">
            <button
              ...
              className="w-full px-3 py-2 rounded-lg font-medium flex items-center justify-center gap-2"
              style={{
            ...
            >
              ...
              <span className="px-1.5 py-0.5 rounded bg-slate-700/50 text-slate-300" style={{ fontSize: theme.fontSize.caption }}>
                ⌘↩
              </span>
            </button>
            <button
              onClick={() => setShowCancelConfirm(true)}
              className="w-full px-3 py-1.5 bg-slate-800 hover:bg-slate-700 rounded-lg font-medium text-slate-400 hover:text-slate-300"
